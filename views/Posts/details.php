<div>
	<div class="div div-details">
		...
		<br/>
		<small>
			<?php echo $item['description'] ?> </small>
		<div class="kap">
			<p>
		...
		endforeach; ?>
			...
			<div class="div-details-buttons">
				<div class="div-details-bottom">
					<div class="div-del-up">
						...
						<?php endif; endif; ?>
						<div class="com-top">
							<button id="showbuttonup" class="btn btn-success btn-posts">Update Post Content</button>
						</div>
					</div>
				</div>
				<div class="div-details-bright">
					<?php if (isset($_SESSION['is_logged_in'])) : if ($_SESSION['user_data']['id'] == $_SESSION['post_user_id']): ?>
			...
			<div id="comup">
				<form method="post" action="<?php echo ROOT_PATH; ?>posts/update">
					...
					<input class="btn btn-warning btn-posts addit" name="submit" type="submit" value="Update Content" />
				</form>
			</div>
			<div>
				<div class="div div-details-comment">
					...
					<div id="com">
						<form method="post" action="<?php echo ROOT_PATH; ?>posts/addcomment">
							...
							<input class="btn btn-warning btn-posts addit" name="submit" type="submit" value="Add It" />
						</form>
					</div>
					<?php endif; ?>
					<!--comment list-->
				...
				foreach ($viewModel as $item):
					...
					<div class="comment-column-flex">
						<div class="comment-bottom-content">
							...
							<div class="comment-bottom-small">
								<small>
									<?php echo $item['email'] ?>
								</small>
							</div>
